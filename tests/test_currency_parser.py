...
@pytest.mark.parametrize(
    ...
    [
        ...
        "1,2,3",  # Incorrectly formatted number
        "abc$",  # Non-numeric value with symbol
        "Twelve Dollars",  # Spelled-out amount
        "1 000,00",  # Improperly spaced number
        "NaN",  # Non-numeric representation
        "INF",  # Infinity value
        "-INF",  # Negative infinity
        "OnlySymbol$",  # Missing value
        "",
        {},
        [],
    ],
